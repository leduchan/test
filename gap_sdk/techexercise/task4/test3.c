...
void taskExecution(void) {
    ...
    if (is_identical) {
        ...
        printf("\n Matrix (matrix1) copy operation is not successful.\n");
    }
    ...
    if (is_identical) {
        ...
        printf("\n Matrix (matrix2) copy operation is not successful.\n");
    }     
    ...
    if (is_identical) {
        ...
        printf("\n The multiplication result  matrix copy operation is not successful.\n");
    }
